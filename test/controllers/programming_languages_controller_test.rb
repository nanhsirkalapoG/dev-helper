...
class ProgrammingLanguagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create programming_language" do
    assert_difference('ProgrammingLanguage.count') do
      post programming_languages_url, params: { programming_language: { name: @programming_language.name, year_of_creation: @programming_language.year_of_creation } }
    end
  ...
  test "should update programming_language" do
    patch programming_language_url(@programming_language), params: { programming_language: { name: @programming_language.name, year_of_creation: @programming_language.year_of_creation } }
