...
class ToolTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tool_type" do
    assert_difference('ToolType.count') do
      post tool_types_url, params: { tool_type: { description: @tool_type.description, name: @tool_type.name, notes: @tool_type.notes } }
    end
  ...
  test "should update tool_type" do
    patch tool_type_url(@tool_type), params: { tool_type: { description: @tool_type.description, name: @tool_type.name, notes: @tool_type.notes } }
